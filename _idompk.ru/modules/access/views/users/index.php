    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-md">
                        <a class="btn btn-primary" href="<?=\yii\helpers\Url::toRoute(['/access/users/create'])?>">Добавить <i class="fa fa-plus"></i></a>
                    </div>
                </div>
            </div>
            <table class="table table-striped mb-none" id="datatable-editable">
                ...
                <tr>
                    ...
                    <th>Логин</th>
                    <th>Email</th>
                    <th class="center" style="width: 12%;">Действие</th>
                </tr>
                </thead>
                <tbody>
                <?
                foreach($model as $record)
                {
                    ...
                    <tr class="gradeX" data-numline="<?=$record['id']?>">
                        ...
                        <td class="center actions">
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/users/update','id'=>$record['id']])?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
        ...
        var EditableTable = {
            ...
            build: function() {
                this.datatable = this.$table.DataTable({
                    dom: '<"row datatables-header form-inline"<"col-sm-12 col-md-6"l><"col-sm-12 col-md-6"f> ><"table-responsive"t><"row datatables-footer"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
                    aoColumns: [
                        { "sWidth": "3%"},
