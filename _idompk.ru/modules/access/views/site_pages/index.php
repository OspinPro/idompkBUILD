...
<section role="main" class="content-body">
  ...
  <section class="panel">
    <header class="panel-heading">
      ...
      <a class="btn btn-primary btn-xs" href="<?=\yii\helpers\Url::toRoute(['/access/site_pages/create'])?>"><i class="fa fa-plus"></i>&nbsp;Добавить</a>
    </header>
    <div class="panel-body">
      <table class="table table-striped mb-none table-country" id="datatable-editable">
        ...
        <?php
          ...
          {
            $parentItem = \app\models\SitePages::find()->where(['id'=>$record['parent_id']])->asArray()->one();
            ?>
            <tr class="gradeX" data-numline="<?=$record['id']?>">
              <td class="text-vertical"><?=$record['id']?></td>
              <td class="text-vertical"><?=$record['link_title']?></td>
              <td class="text-vertical"><?=$parentItem['link_title']?></td>
              <td class="text-vertical"><?=$record['link_url']?></td>
              <td class="text-vertical"><?=$record['date_update']?></td>
              <td class="actions">
                <a href="//<?=$_SERVER['SERVER_NAME']?>/<?=$record['link_url']?>" class="on-default text-info" target="_blank"><i class="fa fa-eye"></i></a>
                <a href="<?=\yii\helpers\Url::toRoute(['/access/site_pages/update','id'=>$record['id']])?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
