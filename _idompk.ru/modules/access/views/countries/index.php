...
<!--            <a class="btn btn-primary btn-xs" href="--><?//=\yii\helpers\Url::toRoute(['/access/countries/create'])?><!--"><i class="fa fa-plus"></i>&nbsp;Добавить</a>-->
        </header>
            ...
            <table class="table table-striped mb-none table-country" id="datatable-editable">
                ...
                foreach($models as $record)
                {
                    ...
                    <tr class="gradeX" data-numline="<?=$record->id?>">
                        ...
                        <td class="actions">
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/countries/update','id'=>$record->id])?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
<!--                            <a onclick="if(!confirm('Вы уверены?')) return false;" href="--><?//=\yii\helpers\Url::toRoute(['/access/countries/delete','id'=>$record->id])?><!--" class="on-default remove-row"><i class="fa fa-trash-o text-danger"></i></a>-->
                        </td>
                    </tr>
                <?php }?>
                </tbody>
