      ...
      <section class="panel">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-5">
              <label class="control-label"><b>Изображение</b></label>
              <br/>
              <?php
              if($model->image)
              {?>
                <img class="img_form" style="max-width: 150px;" src="/img/uploads/other/medium/<?=unserialize($model->image)[0]?>">
              <?php }?>
              <div class="row">
              ...
              <div class="fileupload fileupload-new" data-provides="fileupload">
                <div class="input-append">
                  ...
                  <span class="btn btn-default btn-file">
                                                ...
                                                <span class="fileupload-new"><?=$model->image ? 'Заменить файл' : 'Загрузить файл'?></span>
