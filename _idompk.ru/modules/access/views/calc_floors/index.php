...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title pull-left mr-md">Этажность калькулятора</h2>
            <a class="btn btn-primary btn-xs" href="<?=\yii\helpers\Url::toRoute(['/access/calc_floors/create'])?>"><i class="fa fa-plus"></i>&nbsp;Добавить</a>
            <a class="btn btn-primary btn-xs" href="<?=\yii\helpers\Url::toRoute(['/access/calc_category/index'])?>"><i class="fa fa-plus"></i>&nbsp;Категории</a>
        </header>
        <div class="panel-body">
            <table class="table table-striped mb-none table-city" id="datatable-editable">
                ...
                <tbody>
                <?php
                foreach($models as $floor)
                {?>
                    <tr class="gradeA" data-numline="<?=$floor->id?>">
                        <td><?=$floor->position?></td>
                        <td class="text-vertical"><?=$floor->name?></td>
                        <td class="text-vertical"><?=$floor->sh?></td>
                        <td class="text-vertical"><?=number_format($floor->fl, 0, '.', ' ');?></td>
                        <td class="actions">
                            <a href="#" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                            <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/calc_category','floor_id'=>$floor->id])?>" class="on-default sortup-row"><i class="fa fa-tasks"></i></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="/access/calc_floors/update?id=<?php echo $floor->id; ?>" class="on-default3"><i class="fa fa-pencil"></i></a>
