  ...
  <span class="sidebar-right-toggle"></span>
      ...
      <a class="btn btn-primary btn-xs" href="<?=\yii\helpers\Url::toRoute(['/access/sostav_items/create'])?>"><i class="fa fa-plus"></i>&nbsp;Добавить</a>
  </header>
  ...
  <td class="actions">
      <a href="<?=\yii\helpers\Url::toRoute(['/access/sostav_items/update','id'=>$record['id']])?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                              ...
                              change: function() {
                                  _self.dialog.$confirm.on( 'click', function( e ) {
                                      ...
                                      $.ajax({
                                          type: "POST",
                                          dataType: 'json',
                                          url: "/access/sostav_items/delete",
                                          data:  {
                                              id: $row.data("numline"),
