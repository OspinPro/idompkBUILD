...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title pull-left mr-md">Группы страниц</h2>
        ...
        <div class="panel-body">
            <table class="table table-striped mb-none table-city" id="datatable-editable">
                ...
                foreach(\app\models\FilterCat::find()->asArray()->all() as $country)
                {?>
                    <tr class="gradeA" data-numline="<?=$country['id']?>">
                        ...
                        <td class="actions">
                            ...
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/filter_item','cat'=>$country['id']])?>" class="on-default sortup-row"><i class="fa fa-tasks"></i></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="#" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/filter_pr/up','id'=>$country['id']])?>" class="on-default sortup-row"><i class="fa fa-arrow-up"></i></a>
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/filter_pr/down','id'=>$country['id']])?>" class="on-default sortdown-row"><i class="fa fa-arrow-down"></i></a>
...
<script>
    ...
    $(document).on("click touchstart", ".sort_link_hide", function(e){
        ...
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: "/access/filter_pr/reposition",
            data:  {
                mass: sortArray,
                mass2: sortArray2,
                _csrf: '<?=Yii::$app->request->getCsrfToken()?>'
