...
$items = \yii\helpers\ArrayHelper::map(\app\models\CalcCategories::find()->andWhere(['parent_id' => 0])->all(), 'id', 'name');
$floors = \yii\helpers\ArrayHelper::map(\app\models\CalcFloors::find()->all(), 'id', 'name');
?>
  <div class="row">
    <div class="col-lg-12">
      <?php
      ...
      <section class="panel">
        ...
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <?=Html::activeDropDownList($model, 'parent_id', $items, ['class'=>"form-control", 'prompt' => 'Не выбрано']) ?>
                </div>
            </div>
            <?php if($model->parent_id === 0 || !$model->parent_id): ?>
            <div class="form-group">
                <label class="col-sm-3 control-label">
                    Этажность
                </label>
                <div class="col-sm-8">
                    <?=Html::activeDropDownList($model, 'floor_id', $floors, ['class'=>"form-control", 'prompt' => 'Не выбрано']) ?>
                </div>
            </div>
<?php endif; ?>
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <?= Html::activeCheckbox($model,'is_fundament'); ?>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <?= Html::activeCheckbox($model,'is_cokol'); ?>
                </div>
            </div>
