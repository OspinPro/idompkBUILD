...
$title = 'Посадочные страницы для группы';
$this->title = $title.' - Панель управления';

$fint_cat = \app\models\FilterCat::find()->where(['id'=>$_GET['cat']])->asArray()->one();
...
<section role="main" class="content-body">
    ...
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title pull-left mr-md">Список страниц для группы: <b><?=$fint_cat['name']?></b></h2>

            <a class="btn btn-primary btn-xs" href="<?=\yii\helpers\Url::toRoute(['/access/filter_item/create','cat'=>$_GET['cat']])?>"><i class="fa fa-plus"></i>&nbsp;Добавить</a>
            ...
            <table class="table table-striped mb-none table-country" id="datatable-editable">
                ...
                { ?>
                    <tr class="gradeX" data-numline="<?=$record['id']?>">
                        ...
                        <td class="actions">
                          <a href="/catalog/proekty-domov/<?=$record['url']?>" class="on-default" target="_blank"><i class="fa fa-eye"></i></a>
                            <a href="<?=\yii\helpers\Url::toRoute(['/access/filter_item/update','id'=>$record['id']])?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
