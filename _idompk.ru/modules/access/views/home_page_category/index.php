...
<section role="main" class="content-body">
  ...
  <section class="panel">
    <header class="panel-heading">
      ...
      <a class="btn btn-primary btn-xs" href="<?=\yii\helpers\Url::toRoute(['/access/home_page_category/create'])?>"><i class="fa fa-plus"></i>&nbsp;Добавить</a>
    </header>
      ...
      <table class="table table-striped mb-none table-country" id="datatable-editable">
        ...
        foreach($models as $record)
        {
          ...
          <tr class="gradeX" data-numline="<?=$record['id']?>">
            ...
            <td class="text-vertical"><a href="/img/uploads/other/original/<?=$record['image'];?>" class="image-popup-no-margins"><img width="30" alt="" src="/img/uploads/other/thumb/<?=$record['image'];?>"></a></td>
            <td class="text-vertical"><?=$record['name']?></td>
            <td class="text-vertical">/catalog/proekty-domov/<?=$url_name['url']?></td>
            <td class="actions">
              <a href="<?=\yii\helpers\Url::toRoute(['/access/home_page_category/update','id'=>$record['id']])?>" class="on-default edit-row"><i class="fa fa-pencil"></i></a>
