      ...
      <table style="width: 100% !important;border-collapse: collapse;">
        ...
        <tr>
          <td style="background-color: white;padding: 30px 35px;">
            <?php
            echo '<table style="width: 100% !important;border-collapse: collapse;font-size:12px; vertical-align: top; line-height: 1;margin-bottom:10px;">';
            echo '<tr><td style="padding-bottom: 10px;font-size: 14px;"><a href="https://'.$_SERVER['SERVER_NAME'].''.$array['url'].'"><b>'.$array['name'].'</b></a></td></tr>';
            echo '<tr><td><img width="100%" src="https://'.$_SERVER['SERVER_NAME'].'/'.$array['image'].'" /></td></tr>';
            echo '</table>';
            echo '<table style="width: 100% !important;border-collapse: collapse;width: 100%; vertical-align: top; line-height: 1;">';
            echo '<tr><td width="52%" style="vertical-align: top;">Площадь дома (общая):</td><td style="padding-bottom: 10px;">'.$area.' м<sup>2</sup></td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Террасы и балконы:</td><td style="padding-bottom: 10px;">'.$area_tb.' м<sup>2</sup></td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Габариты дома (Ширина х Глубина):</td><td style="padding-bottom: 10px;">'.$shirina_doma.' х '.$dlina_doma.' м</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Количество спален:</td><td style="padding-bottom: 10px;">'.$spalen.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Количество санузлов:</td><td style="padding-bottom: 10px;">'.$zanuzel.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Этажность:</td><td style="padding-bottom: 10px;">'.$etag.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Фундамент:</td><td style="padding-bottom: 10px;">'.$fundament.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Материал стен:</td><td style="padding-bottom: 10px;">'.$desc_material.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Перекрытия:</td><td style="padding-bottom: 10px;">'.$perekrytija.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Тип крыши:</td><td style="padding-bottom: 10px;">'.$krysha.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Кровельный материал:</td><td style="padding-bottom: 10px;">'.$krovlja.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Наружная отделка:</td><td style="padding-bottom: 10px;">'.$fasad.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Архитектурный стиль:</td><td style="padding-bottom: 10px;">'.$arh.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Дом содержит:</td><td style="padding-bottom: 10px;">'.$dom.'</td></tr>';
            echo '<tr><td width="52%" style="vertical-align: top;">Разделы проекта:</td><td style="padding-bottom: 10px;">'.$razd_pr.'</td></tr>';
            echo '</table>';
            echo '<a style="text-transform: uppercase;text-decoration: none!important;cursor: pointer;font-size: 18px;border: none;width: 100%;position: relative;display: block;max-width: 100%;margin: 20px auto 20px;padding: 0;text-align: center;height: auto;line-height: 39px;font-weight: bold;color: #fff;background: #236cb4;" href="https://'.$_SERVER['SERVER_NAME'].''.$array['url'].'">Посмотреть карточку проекта на сайте</a>';
            ?>
          </td>
        </tr>
      </table>
