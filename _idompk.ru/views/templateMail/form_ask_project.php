            ...
            <table class="table-mail" style="width: 100% !important;border-collapse: collapse;width: 100%; vertical-align: top; line-height: 1;">
              ...
              <?php if ($userArea == 1) {?>
                <tr>
                  ...
                  <td>
                    <p><b>У меня есть участок</b></p>
                  </td>
                </tr>
                <?php if ($userAreaAddress) {?>
                  <tr>
                    <td>
                      <p><i>Адрес участка или кадастровый номер:</i></p>
                    </td>
                    <td>
                      <p><b><?php echo $userAreaAddress; ?></b></p>
                    </td>
                  </tr>
                <?php }?>
              <?php }?>
              <?php if ($userBuildTime) {?>
                <tr>
                  <td>
                    <p><i>Строительство:</i></p>
                  </td>
                  <td>
                    <p><b><?php echo $userBuildTime; ?></b></p>
                  </td>
                </tr>
              <?php }?>
              <tr>
