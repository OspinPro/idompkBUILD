          ...
          <td style="background-color: white;padding: 30px 35px;">
            ...
            <table class="table-mail" style="width: 100% !important;border-collapse: collapse;width: 100%; vertical-align: top; line-height: 1;">
              ...
              <tr>
                ...
                <td>
                  <p><b><?php echo number_format($allsum, 0, ',', ' '); ?></b></p>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <p><b><?php echo number_format($creditsum, 0, ',', ' '); ?></b></p>
                </td>
              </tr>
              <tr>
                <td>
                  <p><i>Первый взнос:</i></p>
                </td>
                <td>
                  <p><b><?php echo number_format($firstsum, 0, ',', ' '); ?></b> (<?php echo $firstprocent; ?>%)</p>
                </td>
              </tr>
              <tr>
                <td>
                  <p><i>Срок кредита:</i></p>
                </td>
                <td>
                  <p><b><?php echo $year; ?> лет</b></p>
                </td>
              </tr>
              <tr>
                <td>
                  <p><i>Годовой процент по кредиту:</i></p>
                </td>
                <td>
                  <p><b><?php echo $yearprocent; ?> %</b></p>
                </td>
              </tr>
              <tr>
                <td>
                  <p><i>Ежемесячный платеж:</i></p>
                </td>
                <td>
                  <p><b><?php echo number_format($monthsum, 0, ',', ' '); ?> в месяц</b></p>
                </td>
              </tr>
            </table>
          </td>
