        ...
        <tr>
          <td style="background-color: white;padding: 30px 35px;">
            ...
            foreach ($array['ids'] as $row) {
              ...
              echo '<tr><td style="padding-bottom: 3px;" colspan="2"><a href="https://'.$_SERVER['SERVER_NAME'].''.$array['url'][$row].'"><b>'.$array['name'][$row].'</b></a></td></tr>';
              echo '<tr style="font-size:12px; vertical-align: top; line-height: 1;">';
              echo '<td style="width: 25%;"><img width="95%" style="margin-left:0!important;" src="https://'.$_SERVER['SERVER_NAME'].'/'.$array['image'][$row].'" /></td>';
              echo '<td>';
              echo '<table style="width: 100% !important;border-collapse: collapse;width: 100%; vertical-align: top; line-height: 1;">';
              echo '<tr><td width="67%">Комплекс чертижей (АС):</td><td>'.$array['idom_js_form_order__price-as'][$row].'</td></tr>';
              if ($array['idom_order-line__z'][$row]) {
                echo '<tr><td width="67%">'.$array['idom_order-line__z'][$row].':</td><td>'.$array['idom_order-line__price-z'][$row].'</td></tr>';
              }
              if ($array['idom_order-line__ps'][$row]) {
                echo '<tr><td width="67%">'.$array['idom_order-line__ps'][$row].':</td><td>'.$array['idom_order-line__price-ps'][$row].'</td></tr>';
              }
              if ($array['idom_order-line__uchastok'][$row]) {
                echo '<tr><td width="67%">'.$array['idom_order-line__uchastok'][$row].':</td><td>'.$array['idom_order-line__price-uchastok'][$row].'</td></tr>';
              }
              if ($array['idom_order-line__copy'][$row]) {
                echo '<tr><td width="67%">'.$array['idom_order-line__copy'][$row].':</td><td>'.$array['idom_order-line__copy-number'][$row].'шт. по '.$array['idom_order-line__price-copy'][$row].'</td></tr>';
              }
              if ($array['idom_order-line__pdf'][$row]) {
                echo '<tr><td width="67%">'.$array['idom_order-line__pdf'][$row].':</td><td>'.$array['idom_order-line__price-pdf'][$row].'</td></tr>';
              }
              if ($array['idom_order-line__enginer'][$row]) {
                echo '<tr><td width="67%">'.$array['idom_order-line__enginer'][$row].':</td><td>'.$array['idom_order-line__price-enginer'][$row].'</td></tr>';
              }
              echo '<tr><td width="67%"><b>Итоговая стоимость проекта:</b></td><td><b>'.$array['summa'][$row].'</b></td></tr>';
              echo '</table>';
            ...
            <table class="table-mail" style="width: 100% !important;border-collapse: collapse;width: 100%; vertical-align: top; line-height: 1;">
              <tr>
                <td>
                  <p><i>Вариант доставки:</i></p>
                </td>
                <td>
                  <p><b><?php echo $deliveryMethod; ?></b></p>
                </td>
              </tr>
              <tr>
                <td>
                  <p><i>Способ оплаты:</i></p>
                </td>
                <td>
                  <p><b><?php echo $payMethod; ?></b></p>
                </td>
              </tr>
              <tr>
                <td>
                  <p><i>Итоговая стоимость заказа:</i></p>
                </td>
                <td>
                  <p><b><?php echo $finalPrice; ?></b></p>
                </td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                <td>
                  <p><i>E-mail клиента:</i></p>
                </td>
                <td>
                  <p><b><?php echo $userMail; ?></b></p>
                </td>
              </tr>
              <?php if ($userAdress) {?>
                <tr>
                  <td>
                    <p><i>Адрес клиента:</i></p>
                  </td>
                  <td>
                    <p><b><?php echo $userAdress; ?></b></p>
                  </td>
                </tr>
              <?php }
              if ($userComment) {?>
                <tr>
                  <td>
                    <p><i>Комментарий к заказу:</i></p>
                  </td>
                  <td>
                    <p><b><?php echo $userComment; ?></b></p>
                  </td>
                </tr>
              <?php } ?>
            </table>
