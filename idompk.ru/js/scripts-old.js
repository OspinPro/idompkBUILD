  ...
  if ($('#idom_top-find-input').length) {
    $("#idom_top-find-input").autocomplete({
      ...
      search: function( event, ui ) {
        ...
        $('.idom_top-find form fieldset').css('z-index','5');
      ...
      close: function( event, ui ) {
        ...
        $('.idom_top-find__btn-reset').hide();
        $('.idom_top-find form fieldset').css('z-index','1');
    ...
    $(document).on('click', '.idom_top-find__btn-reset', function(){
      $('#idom_top-find-input').val('');
      $('.idom_top-find__btn-reset').hide();
      $('.idom_top-find form fieldset').css('z-index','1');
      $('#idom_top-find-result').removeClass('idom_top-find-result--active');
...
$(function(){
  ...
  $('.idompk-calc-addons__image').on('click', function(event){
    event.preventDefault();
  ...
  $('.idompk-calc-addons-spoiler__link').on('click', function(event){
    event.preventDefault();
    $(this).toggleClass('is-active');
  ...
  if ($('.calc-price__value-fixed').length) {
    $(window).on('scroll', function() {
      var offsetLinks = $('.calc-price__value').eq(0).offset().top;

      var hideOffset = $('.calc-price').eq(1).offset().top;
      var hideOffsetHeight = $('.calc-price').eq(1).outerHeight();
